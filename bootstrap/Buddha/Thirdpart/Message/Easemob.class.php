...
class Buddha_Thirdpart_Message_Easemob extends Buddha_Base_Component{
...
//------------------------------------------------------用户体系
    ...
    public function __construct() {
        ...
        $options['client_id']='YXA6Z6rAIKyuEeeikgFfLg6gAA';
        $options['client_secret']='YXA6iGqSdildHC7Kfm5rWde72VBv_Yc';
        $options['org_name']='1120171009115543';
        $options['app_name']='worldchat';
    ...
    */
    ...
    function writeCursor($filename,$content){
        ...
        $myfile=@fopen("resources/txtfile/".$filename,"w+") or die("Unable to open file!");
