...
/**
 * Class Buddha_Captcha_CaptchaBuilder
 */
class Buddha_Captcha_CaptchaBuilder implements Buddha_Captcha_CaptchaBuilderInterface
{
    /**
     * @var array
     */
    ...
    /**
     * @var Buddha_Captcha_PhraseBuilderInterface
     */
    protected $builder;
     ...
     *
     * @return Buddha_Captcha_CaptchaBuilder
     */
    ...
    public function __construct($phrase = null, Buddha_Captcha_PhraseBuilderInterface $builder = null,$length=5)
    {
        if ($builder === null) {
            $this->builder = new Buddha_Captcha_PhraseBuilder;
        } else {
            $this->builder = $builder;
        }

        if ($phrase === null) {
            $phrase = $this->builder->build($length);
        }
     ...
     * Instantiation
     */
    public static function create($phrase = null,$builder=null,$length=5)
    {
        return new self($phrase = null,$builder=null,$length);
    }
