...
{
    /* 财付通网关 */
    var $_gateway   =   'https://mp.weixin.qq.com/cgi-bin/loginpage';
    var $_code      =   'wxpay';
    ...
    function get_payform($order_info)
    {
        ...
        /* 平台提供者,代理商的财付通账号 */
        $chnid = $this->_config['wxpay_account'];

        /* 收款方财付通账号 */
        $seller = $this->_config['wxpay_account'];
        ...
        /* 交易类型：2、虚拟交易，1、实物交易 */
        $mch_type = $this->_config['wxpay_type'];
        ...
        /* 数字签名 */
        $sign_text = "attach=" . $attach . "&chnid=" . $chnid . "&cmdno=" . $cmdno . "&encode_type=" . $encode_type . "&mch_desc=" . $mch_desc . "&mch_name=" . $mch_name . "&mch_price=" . $mch_price ."&mch_returl=" . $mch_returl . "&mch_type=" . $mch_type . "&mch_vno=" . $mch_vno . "&need_buyerinfo=" . $need_buyerinfo ."&seller=" . $seller . "&show_url=" . $show_url . "&version=" . $version . "&key=" . $this->_config['wxpay_key'];
    ...
    function verify_notify($order_info, $strict = false)
    {
        ...
        /* 检查数字签名是否正确 */
        $sign_text = "attach=" . $attach . "&buyer_id=" . $buyer_id . "&cft_tid=" . $cft_tid . "&chnid=" . $chnid . "&cmdno=" . $cmd_no . "&mch_vno=" . $mch_vno . "&retcode=" . $retcode . "&seller=" .$seller . "&status=" . $status . "&total_fee=" . $total_fee . "&trade_price=" . $trade_price . "&transport_fee=" . $transport_fee . "&version=" . $version . "&key=" . $this->_config['wxpay_key'];
