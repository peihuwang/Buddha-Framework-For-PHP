...
class ActivityController extends Buddha_App_Action{
    ...
    public function more(){
        ...
        $c=$this->c;
        $title='活动';
        $searchType = array (1 => '全部'.$title, 2 => '新增'.$title, 3 => '审核通过',4 => '审核未通过', 5=> '下架'.$title, 6=> '推荐', 7=> '热门');
        ...
        if(Buddha_Http_Input::getParameter('job')){
            ...
            switch($job){
                case 'is_sure':
                    $ActivityObj->updateRecords(array('is_sure'=>1,'buddhastatus'=>0),"id IN ($ids)");
                    Buddha_Http_Head::redirect('操作成功','index.php?a=more&c='.$c.'&view='.$view.'&p='.$p);
                    break;
                case 'stop':
                    $ActivityObj->updateRecords(array('is_sure'=>0,'buddhastatus'=>1,'isdel'=>4),"id IN ($ids)");
                    Buddha_Http_Head::redirect('操作成功','index.php?a=more&c='.$c.'&view='.$view.'&p='.$p);
                    break;
                case 'sure':
                    $ActivityObj->updateRecords(array('is_sure'=>1,'buddhastatus'=>0,),"id IN ($ids)");
                    ...
                    break;
                case 'enable':
                    $ActivityObj->updateRecords(array('is_sure'=>1,'buddhastatus'=>0,'isdel'=>0),"id IN ($ids)");
                    Buddha_Http_Head::redirect('操作成功','index.php?a=more&c='.$c.'&view='.$view.'&p='.$p);
                    break;
                case 'is_hot':
                    $ActivityObj->updateRecords(array('is_hot'=>1),"id IN ($ids)");
                    Buddha_Http_Head::redirect('操作成功','index.php?a=more&c='.$c.'&view='.$view.'&p='.$p);
                    break;
                case 'is_rec':
                    $ActivityObj->updateRecords(array('is_rec'=>1),"id IN ($ids)");
                    Buddha_Http_Head::redirect('操作成功','index.php?a=more&c='.$c.'&view='.$view.'&p='.$p);
                    break;
            }
        }
        ...
        $rcount= $ActivityObj->countRecords($where);
    ...
    public function edit(){
        ...
        if(!$id){
            Buddha_Http_Head::redirect('参数错误！',"index.php?a=more&c=activity&p={$p}&view={$view}");
        }
        $demand=$ActivityObj->fetch($id);
        if(!$demand){
            Buddha_Http_Head::redirect('没有找到您要的信息！',"index.php?a=more&c=activity&p={$p}&view={$view}");
        }
        ...
        if(Buddha_Http_Input::isPost()){
            ...
            if($demand){
                Buddha_Http_Head::redirect('编辑成功！',"index.php?a=more&c=activity&p={$p}&view={$view}");
            }else{
                Buddha_Http_Head::redirect('编辑失败！',"index.php?a=more&c=activity&p={$p}&view={$view}");
            }
        }
...
//        $ActivityObj->del($id);
        ...
        if($Db_Usercommon){
            Buddha_Http_Head::redirect('删除成功！',"index.php?a=more&c=activity&p={$p}&view={$view}");
        }else{
            Buddha_Http_Head::redirect('删除失败！',"index.php?a=more&c=activity&p={$p}&view={$view}");
        }
    }
