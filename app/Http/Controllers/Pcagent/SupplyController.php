...
//<!--↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑-->
      ...
      $rcount = $this->db->countRecords( $this->prefix.'supply', $where);
        ...
        $fields =array('id','user_id','shop_id','goods_sn','goods_name','is_promote','market_price','promote_price','promote_start_date','promote_end_date','goods_thumb','buddhastatus','is_sure','remarks','isdel','is_hot','is_rec');
        ...
        foreach($list as $k=>$v) {
            ...
            if ($v['shop_id'] != 0) {
                ...
                if ($nwstiem > $v['promote_start_date'] and $nwstiem >$v['promote_end_date'] and $v['is_promote'] == 0) {
    ...
    public function edit(){
        ...
        if(Buddha_Http_Input::isPost()){
            ...
            if($SupplyObj){
                Buddha_Http_Head::redirect('编辑成功','index.php?a=index&c=supply');
            }else{
                Buddha_Http_Head::redirect('编辑失败','index.php?a=index&c=supply');
            }
        }
