...
/**
 * Class DistrictnounsController
 */
class DistrictnounsController extends Buddha_App_Action{
    ...
    public function __construct()
    {
        ...
        $this->tablenamestr='生活圈物业名称管理';
        $this->tablename='districtnouns';
    }
...
//            /**↑↑↑↑↑↑↑↑↑↑ 置顶参数 ↑↑↑↑↑↑↑↑↑↑**/
    ...
    public function add()
    {
        $DistrictnounsObj = new Districtnouns();
...
//            $data['details'] = $details;
            ...
            $demand_id = $DistrictnounsObj->add($data);
            $datas = array();
            if($demand_id)
            {
                $datas['isok']='true';
