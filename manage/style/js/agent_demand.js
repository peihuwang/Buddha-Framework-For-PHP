    ...
    function insertListDiv(json) {
        ...
        for (var i = 0; i< json.length; i++) {
            ...
            if(json[i].is_sure == "not" ){
                html+='  <span  data-href="index.php?a=edit&c=demand&id='+json[i].id+'">审 核 </span>';
            }else if(json[i].is_sure == "no" ){
                html+='  <span  data-href="index.php?a=edit&c=demand&id='+json[i].id+'">审 核 </span>';
            }else if (json[i].is_sure == "yes"){
                html+='  <span class="stop" id="state_'+json[i].id+'" data-u="'+json[i].user_id+'" data-value="'+json[i].id+'" data-a="isdel" data-c="demand">'+json[i].state+'</span>';
            }
            html+='  </div>';
            //////////////////////////////////
            html+='</div>';
